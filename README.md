...
* **손실 계산 4제곱 추가** : loss_caculation.py 확인
* **테스트 페이지 주소** : http://136.119.234.87/
* **도메인 특화 집중**으로 변경
...
### 3. 학습 모델 및 로직 고도화
* **정규 분포 학습:** 개별 데이터 포인트가 아닌, **Chunk_size** 단위의 가우시안 분포 특성을 학습하도록 변경되었습니다.
~~* **손실 함수 최적화:** **MAE**~~
* **도메인 특화 모델 (Domain Specialization):** - 
